...
Version:	2016.1
Release:	1%{?dist}
Summary:	OpenStack policy manager
...
BuildArch:	noarch
BuildRequires:	python-setuptools antlr-python python2-oslo-config python2-debtcollector
...
%prep
#git archive --format=tar.gz --prefix=openstack-congress-%{version}/ stable/mitaka > openstack-congress.tar.gz
